...
/**
 * The base model interface for the Entry service. Represents a row in the &quot;PM_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link io.github.dinolupo.model.impl.EntryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link io.github.dinolupo.model.impl.EntryImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see Entry
 * @see io.github.dinolupo.model.impl.EntryImpl
 * @see io.github.dinolupo.model.impl.EntryModelImpl
 * @generated
 */
public interface EntryModel extends BaseModel<Entry>, StagedGroupedModel {
    ...
    @Override
    public CacheModel<io.github.dinolupo.model.Entry> toCacheModel();
