...
import io.github.dinolupo.model.EntryModel;
import io.github.dinolupo.model.EntrySoap;
...
/**
 * The base model implementation for the Entry service. Represents a row in the &quot;PM_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link io.github.dinolupo.model.EntryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link EntryImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see EntryImpl
 * @see io.github.dinolupo.model.Entry
 * @see io.github.dinolupo.model.EntryModel
 * @generated
 */
@JSON(strict = true)
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a entry model instance should use the {@link io.github.dinolupo.model.Entry} interface instead.
     */
    public static final String TABLE_NAME = "PM_Entry";
    ...
    public static final String TABLE_SQL_CREATE = "create table PM_Entry (uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,value VARCHAR(75) null,projectId LONG)";
    public static final String TABLE_SQL_DROP = "drop table PM_Entry";
    public static final String ORDER_BY_JPQL = " ORDER BY entry.entryId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY PM_Entry.entryId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.io.github.dinolupo.model.Entry"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.io.github.dinolupo.model.Entry"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.io.github.dinolupo.model.Entry"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.io.github.dinolupo.model.Entry"));
    ...
    public Object clone() {
        ...
        entryImpl.setValue(getValue());
        entryImpl.setProjectId(getProjectId());
    ...
    public void resetOriginalValues() {
        ...
        entryModelImpl._originalProjectId = entryModelImpl._projectId;

        entryModelImpl._setOriginalProjectId = false;
    ...
    public CacheModel<Entry> toCacheModel() {
        ...
        entryCacheModel.value = getValue();

        String value = entryCacheModel.value;

        if ((value != null) && (value.length() == 0)) {
            entryCacheModel.value = null;
        }

        entryCacheModel.projectId = getProjectId();
